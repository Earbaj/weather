                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              Text("Day : ${forcast[index].temp.day.toStringAsFixed(0)}°F"),
                              Text("Max : ${forcast[index].temp.max.toStringAsFixed(0)}°F"),
                              Text("Hum : ${forcast[index].humidity.toStringAsFixed(0)}%"),
                              Text("Wind : ${forcast[index].speed.toStringAsFixed(1)}mi/h"),
                            ],
                          ),
                        ],
                      ),
